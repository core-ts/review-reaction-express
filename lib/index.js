...
var RateController = /** @class */ (function () {
  function RateController(log, rateService, validator, commentValidator, dates, numbers, generate, commentId, userId, author, id) {
    this.log = log;
  ...
  RateController.prototype.getComment = function (req, res) {
    var _this = this;
    var commentId = req.params[this.commentId];
    this.rateService.getComment(commentId).then(function (comment) {
      if (comment) {
  ...
  RateController.prototype.getComments = function (req, res) {
    var _this = this;
    var id = req.params[this.id];
    var author = req.params[this.author];
    var limit = express_ext_1.getInteger(req, 'limit');
    this.rateService.getComments(id, author, limit).then(function (comments) {
